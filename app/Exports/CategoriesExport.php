...
class CategoriesExport implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    ...
    {
        return Category::orderBy('id', 'asc')->get();  // Traemos todas las categorías ordenadas por ID
    }
    ...
    public function map($category): array
    {
        return [
            ...
            $category->created_at->format('d-m-Y H:i:s'), // Fecha de creación formateada
            $category->updated_at->format('d-m-Y H:i:s')  // Fecha de actualización formateada
        ];
    }
    ...
    return [
        ['LISTA DE CATEGORIAS', '', '', '', ''],  // Fila 1 con el título
