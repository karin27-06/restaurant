...
class AreasExport implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    public function collection()
    {
        return Areas::orderBy('id', 'asc')->get();  // Traemos todas las areas ordenados por ID
    }
    ...
    public function map($area): array
    {
        return [
            ...
            $area->created_at->format('d-m-Y H:i:s'), // Fecha de creación formateada
            $area->updated_at->format('d-m-Y H:i:s')  // Fecha de actualización formateada
        ];
    }
    ...
    return [
        ['LISTA DE ÁREAS', '', '', '', ''],  // Fila 1 con el título
