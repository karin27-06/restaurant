...
/*const handleFileChange = async (event: Event) => {
    ...
    try {
        ...
        await axios.post('/api/tipos_clientes/import-excel', formData, {
            headers: { 'Content-Type': 'multipart/form-data' }
        })

        toast.add({ severity: 'success', summary: 'Importación exitosa', detail: 'Tipos de clientes importadas correctamente.' })
        emit('import-success')
        target.value = ''
    } catch (error) {
