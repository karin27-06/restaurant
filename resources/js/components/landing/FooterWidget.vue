            ...
            <div class="col-span-12 md:col-span-10">
                <div class="grid grid-cols-12 gap-8 text-center md:text-left">
                    ...
                    <div class="col-span-12 md:col-span-3">
                        ...
                        <a class="leading-normal text-xl block cursor-pointer mb-2 text-surface-700 dark:text-surface-100">Events<img src="https://sakai.primevue.org/demo/images/landing/new-badge.svg" class="ml-2" /></a>
